...
def feed_main(uncleaned_feedback,incorrect_prog_trace):
	...
	# final_dict = "{('fact', 1): {'$in': [[6, 3], [6, 3]], '$out': ['', ''], 'num': [6, 6], 'k': [1]}, ('fact', 2): {'$in': [[6, 3], [6, 3]], '$out': ['', ''], 'num': [6, 6], 'k': [1, 1], '$cond': [False]}, ('fact', 5): {'$in': [[6, 3], [6, 3]], '$out': ['', ''], 'num': [6, 6], 'k': [1, 1], '$cond': [False, False], 'i': [1]}, ('fact', 6): {'$in': [[6, 3], [6, 3]], '$out': ['', ''], 'num': [6, 6], 'k': [1, 1], '$cond': [False, True], 'i': [1, 1]}, ('fact', 9): {'$in': [[6, 3], [6, 3]], '$out': ['', ''], 'num': [6, 6], 'k': [1, 1], 'i': [1, 1], '$cond': [True, True]}, ('fact', 8): {'$in': [[6, 3], [6, 3]], '$out': ['', ''], 'num': [6, 6], 'i': [1, 2], '$cond': [True, True], 'k': [1, 1]}, ('fact', 7): {'$in': [[6, 3], [6, 3]], '$out': ['', ''], 'num': [6, 6], 'k': [720, 720], 'i': [7, 7], '$cond': [False, False]}, ('fact', 4): {'$in': [[6, 3], [6, 3]], '$out': ['', ''], 'num': [6, 6], 'k': [720, 720], 'i': [7, 7], '$cond': [False, False], '$ret': [720]}, ('main', 1): {'$in': [[6, 3], []], '$out': ['', '120'], '$ret': [<undef>, <undef>], 'n': [<undef>, 6], 'r': [<undef>, 3], 'npr_var': [<undef>, 120]}}"
...
# uncleaned_feedback = "Change '$out := ite(==(%(num', 2), 1), StrAppend(StrAppend($out, StrFormat(Enter an integer: )), StrFormat(%d is an even number, num')), StrAppend(StrAppend($out, StrFormat(Enter an integer: )), StrFormat(%d is an odd number, num')))' to '$out := ite(==(%(num', 2), 0), StrAppend(StrAppend($out, StrFormat(Enter an integer: )), StrFormat(%d is an even number, num')), StrAppend(StrAppend($out, StrFormat(Enter an integer: )), StrFormat(%d is an odd number, num')))' at the beginning of the function 'main' (cost=1.0)"
# final_dict = {('main', 1): {'$in': [[6], []], '$out': ['', 'Enter an integer: 6 is an odd number'], '$ret': ['', 0], 'num': ['', 6]}}
# feed_main(uncleaned_feedback,final_dict) #calling the main feedback function
...
def incorrect_return(clara_feedback, programs,rep_prog, inter, args, ins):
	...
	print("Press 1 to get the brief explanation of return statements, else press any key to continue\n")
	reply = input()
	if reply == '1':
		print("\n------------------------------------------------------------------------------------\n")
		...
		return_explanation()
		print("\n------------------------------------------------------------------------------------\n")
	print("Press 1 to compare correct and incorrect return value\n")
